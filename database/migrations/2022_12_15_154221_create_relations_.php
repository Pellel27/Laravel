...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('plat', function (Blueprint $table) {
            //creation une clé étrangère qui relie un plat et sa photo
            $table->foreignId('photo_plat_id')->references('id')->on('photo_plat_id');
            //création d'un index(accélération de recherche) pour la clé étrangère
            $table->index('photo_plat_id');

            //creation une clé étrangère qui relie un plat et sa catégorie
